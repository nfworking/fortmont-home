...
type TypeVariant = 'Incident' | 'Universal' | 'Service Request' | 'Change Request' | 'Problem';
...
const validTypes: TypeVariant[] = ['Incident', 'Service Request', 'Change Request', 'Problem', 'Universal'];
...
export function TypeBadge({ type, className, ...props }: TypeBadgeProps) {
  const variant: VariantProps<typeof typeVariants>['variant'] =
    validTypes.includes(type as TypeVariant) ? (type as TypeVariant) : 'Incident';
