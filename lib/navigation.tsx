...
export const baseNavigationConfig: NavigationConfig = {
  main: [
    ...
    { title: "My Storage", url: "/my-storage", icon: <Database />, section: 1, badgeVariant: "orange" },
    { title: "Unifi", url: "/dashboard/unifi", icon: <EthernetPort />, section: 1 },
    { title: "Tickets", url: "/admin_ticketing/dashboard", icon: <CommandIcon />, section: 1, badgeVariant: "orange" },
